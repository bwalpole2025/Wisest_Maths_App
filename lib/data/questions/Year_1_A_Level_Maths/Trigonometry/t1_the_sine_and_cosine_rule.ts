...
export const questions: Question[] = [
...

  {
    ...
    workedSolution: {
      steps: [
        {
          stepNumber: 1,
          description: 'Sketch and state Heron\'s formula.',
          workingLatex: '\\text{Area} = \\sqrt{s(s-a)(s-b)(s-c)},\\ \\text{where } s = \\tfrac{a+b+c}{2}',
          explanation: 'Heron\'s formula gives the area from the three sides alone, without first finding an angle.',
          diagram: {
            xMin: -3, xMax: 13, yMin: -3, yMax: 7, hideAxes: true,
            lines: [
              { from: [0, 0], to: [10, 0], label: 'a = 10', labelAt: [5, -1.0] },
              { from: [0, 0], to: [4.45, 5.43], label: 'c = 8', labelAt: [1.5, 2.8] },
              { from: [10, 0], to: [4.45, 5.43], label: 'b = 7', labelAt: [8.0, 2.8] },
            ],
            points: [
              { at: [0, 0], label: 'B', labelAnchor: 'sw' },
              { at: [10, 0], label: 'C', labelAnchor: 'se' },
              { at: [4.45, 5.43], label: 'A', labelAnchor: 'n' },
            ],
          },
        },
        {
          stepNumber: 2,
          description: 'Find the semi-perimeter.',
          workingLatex: 's = \\frac{10 + 7 + 8}{2} = \\frac{25}{2} = 12.5',
          explanation: '',
        },
        {
          stepNumber: 3,
          description: 'Compute each factor.',
          workingLatex: 's - a = 2.5,\\ s - b = 5.5,\\ s - c = 4.5',
          explanation: '',
        },
        {
          stepNumber: 4,
          description: 'Substitute into Heron\'s formula.',
          workingLatex: '\\text{Area} = \\sqrt{12.5 \\times 2.5 \\times 5.5 \\times 4.5}',
          explanation: '',
        },
        {
          stepNumber: 5,
          description: 'Compute the product.',
          workingLatex: 'A = \\sqrt{12.5 \\times 2.5 \\times 5.5 \\times 4.5} = \\sqrt{773.4375}',
          explanation: '\\( 12.5 \\times 2.5 = 31.25 \\); \\( 5.5 \\times 4.5 = 24.75 \\); \\( 31.25 \\times 24.75 = 773.4375 \\).',
        },
        {
          stepNumber: 6,
          description: 'Take the square root.',
          workingLatex: '\\text{Area} = \\sqrt{773.4375} = 27.81\\ldots \\approx 27.8 \\text{ cm}^2',
          explanation: '',
        },
      ],
...

  {
    ...
    examStyle: false,
    yearCreated: 2026,
    tags: ['cosine rule', 'forces', 'parallelogram law'],
    workedSolution: {
      steps: [
        {
          stepNumber: 1,
          description: 'Sketch the parallelogram of forces. The resultant is the diagonal from the common starting point.',
          workingLatex: '|\\vec{F_1}| = 5,\\ |\\vec{F_2}| = 8,\\ \\theta = 60^\\circ',
          explanation: 'When two forces act at the same point with angle \\( \\theta \\) between them, the resultant is the diagonal of the parallelogram they form.',
          diagram: {
            xMin: -2, xMax: 14, yMin: -2, yMax: 9, hideAxes: true,
            lines: [
              { from: [0, 0], to: [8, 0], label: '8 N', labelAt: [4, -0.8] },
              { from: [0, 0], to: [2.5, 4.33], label: '5 N', labelAt: [0.5, 2.5] },
              { from: [8, 0], to: [10.5, 4.33], color: 'gray', dashed: true },
              { from: [2.5, 4.33], to: [10.5, 4.33], color: 'gray', dashed: true },
              { from: [0, 0], to: [10.5, 4.33], label: 'R = ?', labelAt: [4.5, 2.5] },
            ],
            points: [
              { at: [0.866, 0.5], label: '60°', labelAnchor: 'center', r: 0 },
            ],
          },
        },
        {
          stepNumber: 2,
          description: 'For the resultant of two vectors with angle \\( \\theta \\) between them, the formula is \\( R^2 = F_1^2 + F_2^2 + 2 F_1 F_2 \\cos\\theta \\).',
          workingLatex: 'R^2 = 5^2 + 8^2 + 2(5)(8)\\cos 60^\\circ',
          explanation: 'Note the \\( + \\) sign (not \\( - \\)): inside the parallelogram, the angle between one vector and the continuation of the other (forming the triangle leg-to-diagonal) is the supplement \\( 180^\\circ - \\theta \\), and \\( \\cos(180^\\circ - \\theta) = -\\cos\\theta \\), flipping the sign in the cosine rule.',
        },
        {
          stepNumber: 3,
          description: 'Substitute \\( \\cos 60^\\circ = \\tfrac{1}{2} \\).',
          workingLatex: 'R^2 = 25 + 64 + 80 \\times \\tfrac{1}{2} = 89 + 40 = 129',
          explanation: '',
        },
        {
          stepNumber: 4,
          description: 'Take the square root.',
          workingLatex: 'R = \\sqrt{129} = 11.36\\ldots \\approx 11.4 \\text{ N}',
          explanation: '',
        },
      ],
      finalAnswer: '\\( R \\approx 11.4 \\text{ N} \\)',
    },
  },
    ...
    workedSolution: {
      steps: [
        ...
        },
        {
          ...
          workingLatex: 'AC^2 = 225 \\implies AC = 15 \\ \\checkmark',
          explanation: 'Matches the famous 9-12-15 right triangle (a 3-4-5 multiplied by 3).',
        },
      ],
      finalAnswer: 'AC = 15 \\ \\checkmark',
    },
  },
...

  {
    ...
    workedSolution: {
      steps: [
        {
          stepNumber: 1,
          description: 'Recall the extended sine rule.',
          workingLatex: '\\frac{a}{\\sin A} = 2R',
          explanation: 'The "extended" sine rule states that each ratio side/sin(angle) equals the diameter of the circumscribed circle. Proof: construct the diameter through one vertex; the opposite angle is then in a right-angled triangle with hypotenuse \\( 2R \\), giving \\( \\sin A = a / 2R \\).',
          diagram: {
            xMin: -7, xMax: 7, yMin: -7, yMax: 7, hideAxes: true,
            curves: [
              { points: Array.from({length: 60}, (_, i) => [10*Math.cos(i*Math.PI/30), 10*Math.sin(i*Math.PI/30)] as [number, number]).filter(p => p[0] >= -7 && p[0] <= 7 && p[1] >= -7 && p[1] <= 7), color: 'gray' },
            ],
            points: [
              { at: [0, 0], label: 'O', labelAnchor: 's' },
            ],
          },
        },
        {
          ...
          workingLatex: '2R = \\frac{10}{\\sin 30^\\circ} = \\frac{10}{1/2} = 20',
          explanation: '',
        },
        {
          stepNumber: 3,
      ...
      steps: [
        {
          ...
          explanation: '',
          diagram: {
            xMin: -3, xMax: 16, yMin: -3, yMax: 12, hideAxes: true,
            lines: [
              { from: [0, 0], to: [13.57, 0], label: 'c', labelAt: [6.8, -1.0] },
              { from: [0, 0], to: [5.03, 13.83], label: 'b = ?', labelAt: [0.5, 7.0] },
              { from: [13.57, 0], to: [5.03, 13.83], label: 'a = 12', labelAt: [11.5, 7.0] },
            ],
            points: [
              { at: [0, 0], label: 'A', labelAnchor: 'sw' },
              { at: [13.57, 0], label: 'B', labelAnchor: 'se' },
              { at: [5.03, 13.83], label: 'C', labelAnchor: 'n' },
              { at: [1.824, 1.278], label: '50°', labelAnchor: 'center', r: 0 },
              { at: [11.625, 1.085], label: '70°', labelAnchor: 'center', r: 0 },
              { at: [5.257, 11.615], label: '60°', labelAnchor: 'center', r: 0 },
            ],
          },
        },
        {

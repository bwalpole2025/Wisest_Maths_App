...
export const questions: Question[] = [
  { id: "y2df10-001", topicRef: "y2df10", topicTitle: "Rates of Change 01", difficulty: "Challenge", answerType: "expression", questionText: "The side of a cube is increasing at a rate of \\(0.2\\) cm/s. Find the rate at which the volume is increasing when the side length is \\(5\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-002", topicRef: "y2df10", topicTitle: "Rates of Change 02", difficulty: "Standard", answerType: "expression", questionText: "The radius of a circle is increasing at \\(2\\) cm/s. Find the rate at which its area is increasing when \\(r = 5\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-003", topicRef: "y2df10", topicTitle: "Rates of Change 03", difficulty: "Foundation", answerType: "expression", questionText: "The radius of a circle is increasing at \\(3\\) cm/s. Find the rate at which its circumference is increasing.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-004", topicRef: "y2df10", topicTitle: "Rates of Change 04", difficulty: "Standard", answerType: "expression", questionText: "A circle's area is increasing at \\(50\\pi\\) cm²/s. Find the rate at which its radius is increasing when \\(r=5\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-005", topicRef: "y2df10", topicTitle: "Rates of Change 05", difficulty: "Standard", answerType: "expression", questionText: "A circular pond is evaporating so that its radius decreases at \\(0.5\\) cm/s. Find the rate at which its area is decreasing when \\(r=10\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  // ── Sphere ────
  { id: "y2df10-006", topicRef: "y2df10", topicTitle: "Rates of Change 06", difficulty: "Standard", answerType: "expression", questionText: "The radius of a sphere is increasing at \\(3\\) cm/s. Find the rate at which the volume is increasing when \\(r=4\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-007", topicRef: "y2df10", topicTitle: "Rates of Change 07", difficulty: "Standard", answerType: "expression", questionText: "The radius of a sphere is increasing at \\(0.5\\) cm/s. Find the rate at which the surface area is increasing when \\(r=3\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-008", topicRef: "y2df10", topicTitle: "Rates of Change 08", difficulty: "Standard", answerType: "expression", questionText: "A spherical balloon is inflated at \\(100\\pi\\) cm³/s. Find the rate of change of radius when \\(r=5\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-009", topicRef: "y2df10", topicTitle: "Rates of Change 09", difficulty: "Challenge", answerType: "expression", questionText: "A spherical balloon is inflated at \\(400\\pi\\) cm³/s. Find the rate at which its surface area is increasing when \\(r=10\\) cm.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-010", topicRef: "y2df10", topicTitle: "Rates of Change 10", difficulty: "Standard", answerType: "expression", questionText: "The side of a cube is increasing at \\(0.4\\) cm/s. Find the rate at which the surface area is increasing when \\(x=6\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-011", topicRef: "y2df10", topicTitle: "Rates of Change 11", difficulty: "Foundation", answerType: "expression", questionText: "The side of a square is increasing at \\(2\\) cm/s. Find the rate of increase of the perimeter.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-012", topicRef: "y2df10", topicTitle: "Rates of Change 12", difficulty: "Foundation", answerType: "expression", questionText: "The side of a square is increasing at \\(3\\) cm/s. Find the rate of increase of area when side is \\(4\\) cm.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-013", topicRef: "y2df10", topicTitle: "Rates of Change 13", difficulty: "Challenge", answerType: "expression", questionText: "A cube's volume is increasing at \\(48\\) cm³/s. Find the rate of change of the side length when \\(x = 4\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  // ── Cylinder ────
  { id: "y2df10-014", topicRef: "y2df10", topicTitle: "Rates of Change 14", difficulty: "Challenge", answerType: "expression", questionText: "A cylinder with fixed height \\(10\\) cm has its radius increasing at \\(0.5\\) cm/s. Find the rate of change of volume when \\(r=3\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-015", topicRef: "y2df10", topicTitle: "Rates of Change 15", difficulty: "Standard", answerType: "expression", questionText: "A cylinder of fixed radius \\(4\\) cm has its height increasing at \\(2\\) cm/s. Find the rate of volume change.", marks: 3, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-016", topicRef: "y2df10", topicTitle: "Rates of Change 16", difficulty: "Challenge", answerType: "expression", questionText: "Water is poured into a cone (apex down) at \\(10\\) cm³/s. The cone has radius-to-height ratio \\(1:2\\). Find the rate at which the water level rises when \\(h = 4\\) cm.", marks: 6, examStyle: true, yearCreated: 2026, tags: ["rates", "cone"], workedSolution: { steps: [
  ...
  { id: "y2df10-017", topicRef: "y2df10", topicTitle: "Rates of Change 17", difficulty: "Challenge", answerType: "expression", questionText: "Water flows into a cone at \\(2\\) cm³/s. The cone has \\(r:h = 1:3\\). Find \\(dh/dt\\) when \\(h=6\\) cm.", marks: 6, examStyle: true, yearCreated: 2026, tags: ["rates", "cone"], workedSolution: { steps: [
  ...
  { id: "y2df10-018", topicRef: "y2df10", topicTitle: "Rates of Change 18", difficulty: "Standard", answerType: "expression", questionText: "Water drains from a cylinder of radius \\(10\\) cm at \\(5\\pi\\) cm³/s. Find the rate of decrease of water depth.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
    { stepNumber: 1, description: "Write the cylinder-volume formula.", workingLatex: "V = \\pi r^2 h", explanation: "Standard formula." },
  ...
  { id: "y2df10-020", topicRef: "y2df10", topicTitle: "Rates of Change 20", difficulty: "Challenge", answerType: "expression", questionText: "A \\(5\\) m ladder leans against a wall. The top slides down at \\(0.3\\) m/s. Find \\(dx/dt\\) when foot is \\(3\\) m away.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  // ── Various ────
  { id: "y2df10-021", topicRef: "y2df10", topicTitle: "Rates of Change 21", difficulty: "Standard", answerType: "expression", questionText: "Oil spreads in a circular patch with radius increasing at \\(4\\) cm/min. Find the rate of increase of area when \\(r=50\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-022", topicRef: "y2df10", topicTitle: "Rates of Change 22", difficulty: "Standard", answerType: "expression", questionText: "A particle's displacement is \\( s = 3t^2 - t^3 \\). Find its velocity at \\(t=2\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates", "mechanics"], workedSolution: { steps: [
  ...
  { id: "y2df10-023", topicRef: "y2df10", topicTitle: "Rates of Change 23", difficulty: "Standard", answerType: "expression", questionText: "A particle's displacement is \\( s = 2t^3 - 5t^2 \\). Find its acceleration at \\(t = 3\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates", "mechanics"], workedSolution: { steps: [
  ...
  { id: "y2df10-024", topicRef: "y2df10", topicTitle: "Rates of Change 24", difficulty: "Challenge", answerType: "expression", questionText: "A rectangle has length increasing at \\(2\\) cm/s and width at \\(3\\) cm/s. Find the rate of change of area when length = 10, width = 6 cm.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates", "product"], workedSolution: { steps: [
  ...
  // ── More spheres/cubes ────
  { id: "y2df10-025", topicRef: "y2df10", topicTitle: "Rates of Change 25", difficulty: "Challenge", answerType: "expression", questionText: "A sphere's surface area is decreasing at \\(16\\pi\\) cm²/s. Find the rate of change of radius when \\(r = 4\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-026", topicRef: "y2df10", topicTitle: "Rates of Change 26", difficulty: "Challenge", answerType: "expression", questionText: "An ice cube melts uniformly so that its surface area decreases at \\(12\\) cm²/s. Find the rate of change of volume when the side is \\(5\\) cm.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-027", topicRef: "y2df10", topicTitle: "Rates of Change 27", difficulty: "Challenge", answerType: "expression", questionText: "A particle's displacement is \\( s = t e^{-t} \\). Find its velocity at \\(t = 1\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-028", topicRef: "y2df10", topicTitle: "Rates of Change 28", difficulty: "Standard", answerType: "expression", questionText: "A ball's height above ground is \\( h = 20t - 5t^2 \\). Find its velocity at \\(t=1\\).", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-029", topicRef: "y2df10", topicTitle: "Rates of Change 29", difficulty: "Standard", answerType: "expression", questionText: "For \\( h = 20t - 5t^2 \\), find the maximum height reached.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-031", topicRef: "y2df10", topicTitle: "Rates of Change 31", difficulty: "Challenge", answerType: "expression", questionText: "A lamp is \\(6\\) m tall; a \\(1.5\\) m person walks away at \\(2\\) m/s. Find the rate at which the shadow length increases.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-032", topicRef: "y2df10", topicTitle: "Rates of Change 32", difficulty: "Challenge", answerType: "expression", questionText: "An equilateral triangle has side length increasing at \\(1\\) cm/s. Find the rate of change of area when the side is \\(4\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-033", topicRef: "y2df10", topicTitle: "Rates of Change 33", difficulty: "Standard", answerType: "expression", questionText: "A sector has angle \\(\\pi/3\\) rad and radius increasing at \\(1\\) cm/s. Find the rate of area change when \\(r=6\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-034", topicRef: "y2df10", topicTitle: "Rates of Change 34", difficulty: "Standard", answerType: "expression", questionText: "A sector has fixed radius \\(10\\) cm and angle increasing at \\(\\pi/12\\) rad/s. Find the rate of area change.", marks: 3, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-035", topicRef: "y2df10", topicTitle: "Rates of Change 35", difficulty: "Challenge", answerType: "expression", questionText: "A rectangle has area \\(60\\) cm² (fixed). Width increases at \\(2\\) cm/s. Find the rate of change of length when width = 4 cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-036", topicRef: "y2df10", topicTitle: "Rates of Change 36", difficulty: "Challenge", answerType: "expression", questionText: "An ice cube melts so its volume decreases at \\(6\\) cm³/s. Find \\(dx/dt\\) when \\(x = 3\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  // ── Various rate setups ────
  { id: "y2df10-037", topicRef: "y2df10", topicTitle: "Rates of Change 37", difficulty: "Challenge", answerType: "expression", questionText: "A boat is \\(3\\) km from a straight shore, pulled along a rope at \\(2\\) km/h. Find the rate of change of the angle \\(\\theta\\) between the rope and shore when the rope is 5 km long.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates", "trig"], workedSolution: { steps: [
  ...
  { id: "y2df10-038", topicRef: "y2df10", topicTitle: "Rates of Change 38", difficulty: "Standard", answerType: "expression", questionText: "Gas obeys \\(PV = 100\\). Pressure increases at \\(4\\) Pa/s. Find \\(dV/dt\\) when \\(V = 20\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-039", topicRef: "y2df10", topicTitle: "Rates of Change 39", difficulty: "Standard", answerType: "expression", questionText: "A hemispherical bowl has radius increasing at \\(0.2\\) cm/s. Find the rate of change of its volume when \\(r = 3\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-040", topicRef: "y2df10", topicTitle: "Rates of Change 40", difficulty: "Challenge", answerType: "expression", questionText: "A cooling object's temperature satisfies \\( T = 80e^{-0.1t} + 20 \\). Find \\(dT/dt\\) when \\(T = 60\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates", "exp"], workedSolution: { steps: [
  ...
  { id: "y2df10-041", topicRef: "y2df10", topicTitle: "Rates of Change 41", difficulty: "Standard", answerType: "expression", questionText: "A population satisfies \\( P = 100e^{0.05t} \\). Find \\(dP/dt\\) when \\(P = 200\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates", "exp"], workedSolution: { steps: [
  ...
  { id: "y2df10-042", topicRef: "y2df10", topicTitle: "Rates of Change 42", difficulty: "Standard", answerType: "expression", questionText: "A sample satisfies \\( N = 500 e^{-0.02t} \\). Find \\(dN/dt\\) in terms of \\(N\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates", "exp"], workedSolution: { steps: [
  ...
  { id: "y2df10-043", topicRef: "y2df10", topicTitle: "Rates of Change 43", difficulty: "Challenge", answerType: "expression", questionText: "An equilateral triangle has area increasing at \\(3\\sqrt{3}\\) cm²/s. Find \\(ds/dt\\) when \\(s = 6\\) cm.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-044", topicRef: "y2df10", topicTitle: "Rates of Change 44", difficulty: "Standard", answerType: "expression", questionText: "A ball falls so that \\(s = 5t^2\\). Find its velocity at \\(t=2\\) s.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-045", topicRef: "y2df10", topicTitle: "Rates of Change 45", difficulty: "Challenge", answerType: "expression", questionText: "A cylinder has \\(r=3\\) cm increasing at \\(0.2\\) cm/s, and height \\(h=5\\) cm increasing at \\(0.5\\) cm/s. Find \\(dV/dt\\).", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-046", topicRef: "y2df10", topicTitle: "Rates of Change 46", difficulty: "Standard", answerType: "expression", questionText: "Water fills a cone (apex down) with semi-vertical angle \\(\\tan^{-1}(1/2)\\). Find \\(dV/dh\\) when \\(h = 4\\) cm.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-047", topicRef: "y2df10", topicTitle: "Rates of Change 47", difficulty: "Standard", answerType: "expression", questionText: "A stone drops into water and creates a circular ripple whose radius grows at \\(0.5\\) m/s. Find the rate of area change when \\(r=3\\) m.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-048", topicRef: "y2df10", topicTitle: "Rates of Change 48", difficulty: "Challenge", answerType: "expression", questionText: "A sphere is expanding so that its volume doubles every \\(5\\) s. Find the rate of volume change when \\(V = 100\\) cm³.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-049", topicRef: "y2df10", topicTitle: "Rates of Change 49", difficulty: "Challenge", answerType: "expression", questionText: "A cloud mass \\(m\\) grows according to \\( m = 2e^{0.3t} \\). Find \\(dm/dt\\) when \\(m = 8\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-050", topicRef: "y2df10", topicTitle: "Rates of Change 50", difficulty: "Challenge", answerType: "expression", questionText: "A spherical snowball melts so that \\(dV/dt = -k\\cdot S\\) for positive constant \\(k\\). Show \\(dr/dt\\) is constant.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates", "proof"], workedSolution: { steps: [
  ...
  { id: "y2df10-051", topicRef: "y2df10", topicTitle: "Rates of Change 51", difficulty: "Standard", answerType: "expression", questionText: "A square pyramid has height \\(h\\) fixed at 6 and base side \\(x\\) increasing at \\(0.5\\) cm/s. Find rate of volume change when \\(x = 4\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-052", topicRef: "y2df10", topicTitle: "Rates of Change 52", difficulty: "Challenge", answerType: "expression", questionText: "A rectangle has fixed perimeter \\(40\\) cm. Its width increases at \\(2\\) cm/s. Find the rate of area change when \\(w = 8\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-053", topicRef: "y2df10", topicTitle: "Rates of Change 53", difficulty: "Challenge", answerType: "expression", questionText: "Water flows into a cylindrical tank of radius \\(2\\) m at \\(4\\pi\\) m³/min. Find the rate at which water level rises.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-054", topicRef: "y2df10", topicTitle: "Rates of Change 54", difficulty: "Challenge", answerType: "expression", questionText: "Boat A moves north at \\(15\\) km/h, Boat B moves east from same starting point at \\(20\\) km/h. Find rate of separation when both have travelled \\(1\\) hour.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates", "pythagoras"], workedSolution: { steps: [
  ...
  { id: "y2df10-055", topicRef: "y2df10", topicTitle: "Rates of Change 55", difficulty: "Challenge", answerType: "expression", questionText: "A right triangle has legs \\(a\\) and \\(b\\). \\(a\\) increases at 1 cm/s, \\(b\\) decreases at 2 cm/s. Find the rate of change of the hypotenuse when \\(a=3, b=4\\).", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-056", topicRef: "y2df10", topicTitle: "Rates of Change 56", difficulty: "Standard", answerType: "expression", questionText: "Coffee temperature \\( T = 20 + 60e^{-0.1t} \\). Find \\(dT/dt\\) at \\(t=10\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-057", topicRef: "y2df10", topicTitle: "Rates of Change 57", difficulty: "Standard", answerType: "expression", questionText: "A bacterial culture has size \\( N = 50\\cdot 2^{t/3} \\). Find \\(dN/dt\\) at \\(t=0\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-058", topicRef: "y2df10", topicTitle: "Rates of Change 58", difficulty: "Foundation", answerType: "expression", questionText: "Write the rate of change of circle area \\(A = \\pi r^2\\) in terms of \\(dr/dt\\).", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates", "theory"], workedSolution: { steps: [
  ...
  { id: "y2df10-059", topicRef: "y2df10", topicTitle: "Rates of Change 59", difficulty: "Foundation", answerType: "expression", questionText: "Write \\(dV/dt\\) for a sphere in terms of \\(r\\) and \\(dr/dt\\).", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates", "theory"], workedSolution: { steps: [
  ...
  { id: "y2df10-060", topicRef: "y2df10", topicTitle: "Rates of Change 60", difficulty: "Standard", answerType: "expression", questionText: "A tray's temperature \\(T = 180 - 160e^{-0.2t}\\). Find \\(dT/dt\\) at \\(t=0\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-061", topicRef: "y2df10", topicTitle: "Rates of Change 61", difficulty: "Challenge", answerType: "expression", questionText: "A ship sails north at \\(5\\) km/h. A receiver on shore is \\(2\\) km east of the starting point. Find rate at which the straight-line distance between them changes at \\(t=1\\) h.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-062", topicRef: "y2df10", topicTitle: "Rates of Change 62", difficulty: "Standard", answerType: "expression", questionText: "A bar's length varies with temperature: \\(L = 100 + 0.01T\\). If \\(T\\) increases at \\(2\\) °C/min, find \\(dL/dt\\).", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-063", topicRef: "y2df10", topicTitle: "Rates of Change 63", difficulty: "Challenge", answerType: "expression", questionText: "Water fills a rectangular trough (\\(1\\) m wide, \\(3\\) m long) at \\(6\\) litres/min. Find the rate at which water depth rises. (\\(1\\) L = \\(0.001\\) m³.)", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-064", topicRef: "y2df10", topicTitle: "Rates of Change 64", difficulty: "Challenge", answerType: "expression", questionText: "A kite is rising vertically at \\(2\\) m/s; horizontal distance from observer is fixed at \\(100\\) m. Find the rate at which the string length changes when string = \\(150\\) m.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-065", topicRef: "y2df10", topicTitle: "Rates of Change 65", difficulty: "Challenge", answerType: "expression", questionText: "A plane flies horizontally at \\(500\\) km/h at altitude \\(5\\) km. Find the rate at which its distance from an observer on the ground is increasing when the plane is directly \\(12\\) km (horizontal) from the observer.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-066", topicRef: "y2df10", topicTitle: "Rates of Change 66", difficulty: "Challenge", answerType: "expression", questionText: "Charge on a capacitor: \\( Q = 5 e^{-0.1t} \\) coulombs. Find the current \\(i = -dQ/dt\\) at \\(t=10\\) s.", marks: 3, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-067", topicRef: "y2df10", topicTitle: "Rates of Change 67", difficulty: "Challenge", answerType: "expression", questionText: "Sand pours at \\(30\\) cm³/s onto a cone-shaped pile whose height always equals the base radius. Find \\(dh/dt\\) when \\(h=10\\) cm.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-068", topicRef: "y2df10", topicTitle: "Rates of Change 68", difficulty: "Challenge", answerType: "expression", questionText: "A lighthouse beacon \\(1\\) km from shore revolves at \\(\\pi\\) rad/s. Find the speed at which the light hits a point on the shore \\(2\\) km from the lighthouse's closest point.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-069", topicRef: "y2df10", topicTitle: "Rates of Change 69", difficulty: "Challenge", answerType: "expression", questionText: "A tree's height \\(h = 20 - 18e^{-0.1t}\\) m. Find \\(dh/dt\\) when \\(h = 10\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["rates"], workedSolution: { steps: [
  ...
  { id: "y2df10-071", topicRef: "y2df10", topicTitle: "Rates of Change 71", difficulty: "Foundation", answerType: "expression", questionText: "State the chain-rule identity linking \\(\\tfrac{dQ}{dt}\\), \\(\\tfrac{dQ}{dx}\\) and \\(\\tfrac{dx}{dt}\\).", marks: 2, examStyle: false, yearCreated: 2026, tags: ["rates", "theory"], workedSolution: { steps: [

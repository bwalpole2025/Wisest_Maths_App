...
export const questions: Question[] = [
  ...
  { id: "y2nm3-027", topicRef: "y2nm3", topicTitle: "Sketching Iteration 27", difficulty: "Standard", questionText: "Sketch the staircase diagram for \\(x_{n+1} = \\sqrt{3 x_{n} - 2}\\) starting from \\(x_{0} = 1\\) and show convergence to \\(\\alpha = 2\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["staircase"], workedSolution: { steps: [ { stepNumber: 1, description: "Find the fixed points", workingLatex: "\\alpha = \\sqrt{3\\alpha - 2} \\Rightarrow \\alpha^{2} = 3\\alpha - 2 \\Rightarrow \\alpha^{2} - 3\\alpha + 2 = 0", explanation: "Square both sides of \\(g(\\alpha) = \\alpha\\) to remove the root, then collect into a quadratic." }, { stepNumber: 2, description: "Solve the quadratic", workingLatex: "(\\alpha - 1)(\\alpha - 2) = 0 \\Rightarrow \\alpha = 1 \\text{ or } \\alpha = 2", explanation: "There are two candidate fixed points. We must test each one's stability rather than assume which the iteration reaches." }, { stepNumber: 3, description: "Test stability with the derivative", workingLatex: "g'(x) = \\tfrac{3}{2\\sqrt{3x - 2}};\\ g'(2) = \\tfrac{3}{4} = 0.75,\\ g'(1) = \\tfrac{3}{2} = 1.5", explanation: "At \\(\\alpha = 2\\) the slope is below 1 (attracting); at \\(\\alpha = 1\\) it exceeds 1 (repelling). So iterates starting near 1 are pushed toward 2." }, { stepNumber: 4, description: "Classify and sketch the staircase", workingLatex: "0 < g'(2) < 1", explanation: "From \\(x_0 = 1\\) the positive slope under 1 produces a monotone staircase climbing up to \\(\\alpha = 2\\). Draw \\(y = \\sqrt{3x - 2}\\) with \\(y = x\\); step up to the curve and across to the line toward the crossing at 2.", diagram: cobwebDiagram((x) => Math.sqrt(3 * x - 2), [0.8, 2.5], [0.8, 2.5], 1, 5) } ], finalAnswer: "Staircase converging to \\(\\alpha = 2\\)." } },

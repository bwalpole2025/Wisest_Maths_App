...
export const questions: Question[] = [
  ...
  { id: "y2nm3-003", topicRef: "y2nm3", topicTitle: "Sketching Iteration 03", difficulty: "Foundation", answerType: "expression", questionText: "State the condition on \\(g'(\\alpha)\\) for the iteration \\(x_{n+1} = g(x_{n})\\) to converge to the fixed point \\(\\alpha\\).", marks: 1, examStyle: false, yearCreated: 2026, tags: ["concept"], workedSolution: { steps: [ { stepNumber: 1, description: "State the modulus condition on the gradient.", workingLatex: "|g'(\\alpha)| < 1", explanation: "Convergence depends on the steepness of \\(g\\) at the fixed point, not its sign. Use the modulus: as long as the gradient lies strictly between \\(-1\\) and \\(1\\) the iteration is attracted to \\(\\alpha\\). If \\(|g'(\\alpha)| > 1\\) it diverges, and \\(|g'(\\alpha)| = 1\\) is a borderline case." } ], finalAnswer: "\\(|g'(\\alpha)| < 1\\)." } },
  { id: "y2nm3-004", topicRef: "y2nm3", topicTitle: "Sketching Iteration 04", difficulty: "Foundation", answerType: "expression", questionText: "Where on a sketch does the fixed point \\(\\alpha\\) of \\(x_{n+1} = g(x_{n})\\) appear?", marks: 1, examStyle: false, yearCreated: 2026, tags: ["concept"], workedSolution: { steps: [ { stepNumber: 1, description: "Use the defining property of a fixed point.", workingLatex: "g(\\alpha) = \\alpha", explanation: "A fixed point is a value that maps to itself, so at \\(x = \\alpha\\) the curve height \\(g(\\alpha)\\) equals the line height \\(\\alpha\\). Geometrically that is exactly where \\(y = g(x)\\) meets \\(y = x\\); it is not simply where the curve crosses an axis.",
  ...
  { id: "y2nm3-012", topicRef: "y2nm3", topicTitle: "Sketching Iteration 12", difficulty: "Foundation", answerType: "expression", questionText: "If \\(g'(\\alpha) = 0\\), describe the shape of the staircase diagram near the fixed point.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["concept"], workedSolution: { steps: [
  ...
  { id: "y2nm3-013", topicRef: "y2nm3", topicTitle: "Sketching Iteration 13", difficulty: "Foundation", answerType: "expression", questionText: "On a staircase diagram, from which element of the diagram do you read the value of \\(x_{1}\\)?", marks: 2, examStyle: false, yearCreated: 2026, tags: ["concept"], workedSolution: { steps: [
  ...
  { id: "y2nm3-014", topicRef: "y2nm3", topicTitle: "Sketching Iteration 14", difficulty: "Foundation", answerType: "expression", questionText: "State the slope of the line \\(y = x\\) and explain why it always appears on a staircase diagram.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["concept"], workedSolution: { steps: [
  ...
  { id: "y2nm3-015", topicRef: "y2nm3", topicTitle: "Sketching Iteration 15", difficulty: "Foundation", answerType: "expression", questionText: "A diagram shows \\(y = g(x)\\) crossing \\(y = x\\) at \\(\\alpha\\) with slope approximately 0.2. Classify the iteration's behaviour.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["classification"], workedSolution: { steps: [
  ...
  { id: "y2nm3-016", topicRef: "y2nm3", topicTitle: "Sketching Iteration 16", difficulty: "Foundation", answerType: "expression", questionText: "A diagram shows \\(y = g(x)\\) crossing \\(y = x\\) at \\(\\alpha\\) with slope approximately \\(-0.3\\). Classify the iteration's behaviour.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["classification"], workedSolution: { steps: [
  ...
  { id: "y2nm3-017", topicRef: "y2nm3", topicTitle: "Sketching Iteration 17", difficulty: "Foundation", answerType: "expression", questionText: "A diagram shows \\(y = g(x)\\) crossing \\(y = x\\) at \\(\\alpha\\) with slope approximately 1.4. Classify the iteration's behaviour.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["classification", "divergence"], workedSolution: { steps: [
  ...
  { id: "y2nm3-018", topicRef: "y2nm3", topicTitle: "Sketching Iteration 18", difficulty: "Foundation", answerType: "expression", questionText: "A diagram shows \\(y = g(x)\\) crossing \\(y = x\\) at \\(\\alpha\\) with slope approximately \\(-1.5\\). Classify the iteration's behaviour.", marks: 2, examStyle: false, yearCreated: 2026, tags: ["classification", "divergence"], workedSolution: { steps: [
  ...
  { id: "y2nm3-019", topicRef: "y2nm3", topicTitle: "Sketching Iteration 19", difficulty: "Standard", answerType: "expression", questionText: "Sketch the staircase diagram for \\(x_{n+1} = \\sqrt{x_{n} + 2}\\) starting from \\(x_{0} = 0\\). State the fixed point.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["staircase"], workedSolution: { steps: [
  ...
  { id: "y2nm3-020", topicRef: "y2nm3", topicTitle: "Sketching Iteration 20", difficulty: "Standard", answerType: "expression", questionText: "Sketch the staircase diagram for \\(x_{n+1} = \\sqrt[3]{x_{n} + 1}\\) starting from \\(x_{0} = 1\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["staircase"], workedSolution: { steps: [
  ...
  { id: "y2nm3-041", topicRef: "y2nm3", topicTitle: "Sketching Iteration 41", difficulty: "Standard", answerType: "expression", questionText: "For the iteration in Q40, explain what would happen if we started from \\(x_{0} = 3\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["divergence"], workedSolution: { steps: [
  ...
  { id: "y2nm3-042", topicRef: "y2nm3", topicTitle: "Sketching Iteration 42", difficulty: "Standard", answerType: "expression", questionText: "Sketch the cobweb diagram for the logistic iteration \\(x_{n+1} = 2x_{n}(1 - x_{n})\\) starting from \\(x_{0} = 0.1\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["cobweb", "logistic"], workedSolution: { steps: [
  ...
  { id: "y2nm3-043", topicRef: "y2nm3", topicTitle: "Sketching Iteration 43", difficulty: "Standard", answerType: "expression", questionText: "Describe the behaviour of the iteration \\(x_{n+1} = 3.2 x_{n}(1 - x_{n})\\) starting from \\(x_{0} = 0.2\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["cobweb", "logistic"], workedSolution: { steps: [
  ...
  { id: "y2nm3-045", topicRef: "y2nm3", topicTitle: "Sketching Iteration 45", difficulty: "Standard", answerType: "expression", questionText: "For the iteration \\(x_{n+1} = 0.4 x_{n} + 3\\) starting from \\(x_{0} = 0\\), state the fixed point and sketch the staircase.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["staircase", "linear"], workedSolution: { steps: [
  ...
  { id: "y2nm3-046", topicRef: "y2nm3", topicTitle: "Sketching Iteration 46", difficulty: "Standard", answerType: "expression", questionText: "Sketch \\(y = \\sin x\\) and \\(y = x\\) together and explain why the only fixed point of \\(x_{n+1} = \\sin x_{n}\\) is \\(x = 0\\), and show that it is a borderline case.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["concept", "trigonometric"], workedSolution: { steps: [
  ...
  { id: "y2nm3-047", topicRef: "y2nm3", topicTitle: "Sketching Iteration 47", difficulty: "Standard", answerType: "expression", questionText: "Sketch the staircase diagram for \\(x_{n+1} = \\tfrac{1}{4}(x_{n}^{2} + 3)\\) starting from \\(x_{0} = 0.5\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["staircase"], workedSolution: { steps: [
  ...
  { id: "y2nm3-048", topicRef: "y2nm3", topicTitle: "Sketching Iteration 48", difficulty: "Standard", answerType: "expression", questionText: "Use the sketched iteration in Q47 to estimate, to 1 decimal place, the value of \\(x_{3}\\) when \\(x_{0} = 0.5\\).", marks: 3, examStyle: true, yearCreated: 2026, tags: ["staircase"], workedSolution: { steps: [
  ...
  { id: "y2nm3-049", topicRef: "y2nm3", topicTitle: "Sketching Iteration 49", difficulty: "Standard", answerType: "expression", questionText: "Sketch and describe the behaviour of \\(x_{n+1} = 3\\sqrt{x_{n}} - 2\\) starting from \\(x_{0} = 2\\).", marks: 4, examStyle: true, yearCreated: 2026, tags: ["staircase"], workedSolution: { steps: [
  ...
  { id: "y2nm3-062", topicRef: "y2nm3", topicTitle: "Sketching Iteration 62", difficulty: "Challenge", answerType: "expression", questionText: "Sketch the diagram for \\(x_{n+1} = 4x_{n}(1 - x_{n})\\) starting from \\(x_{0} = 0.2\\). Comment on the behaviour.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["logistic", "chaotic"], workedSolution: { steps: [
  ...
  { id: "y2nm3-063", topicRef: "y2nm3", topicTitle: "Sketching Iteration 63", difficulty: "Challenge", answerType: "expression", questionText: "Sketch the staircase for \\(x_{n+1} = \\tfrac{1}{2}(x_{n} + 1)^{1/2}\\) starting from \\(x_{0} = 0.5\\). State the fixed-point equation.", marks: 5, examStyle: true, yearCreated: 2026, tags: ["staircase"], workedSolution: { steps: [
  ...
  { id: "y2nm3-064", topicRef: "y2nm3", topicTitle: "Sketching Iteration 64", difficulty: "Challenge", answerType: "expression", questionText: "Sketch the cobweb for \\(x_{n+1} = \\tfrac{3}{x_{n} + 2}\\) starting from \\(x_{0} = 0\\) and state the fixed-point equation.", marks: 4, examStyle: true, yearCreated: 2026, tags: ["cobweb"], workedSolution: { steps: [

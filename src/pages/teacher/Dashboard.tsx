      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-3">
                  ...
                  {mockStudents.map((s) => (
                    <tr key={s.id} className="border-b border-border last:border-0 hover:bg-muted/30">
                      ...
                      <td className="px-4 py-3 text-right">
                        <Link to="/teacher/students" className="text-xs font-medium text-accent hover:underline">
                          View
                        </Link>
                      </td>
                    </tr>
        ...
        <aside className="space-y-6">
          ...
          <section>
            ...
            <div className="mt-3 space-y-2">
              <Link to="/teacher/question-bank" className="block rounded-md bg-accent px-4 py-2.5 text-center text-sm font-semibold text-white hover:bg-accent/90">
                Add Question to Bank
              </Link>
              <Link to="/teacher/question-bank" className="block rounded-md border border-border px-4 py-2.5 text-center text-sm font-semibold text-foreground hover:bg-muted">
                View Full Question Bank
              </Link>
              <Link to="/teacher/topics" className="block rounded-md border border-border px-4 py-2.5 text-center text-sm font-semibold text-foreground hover:bg-muted">

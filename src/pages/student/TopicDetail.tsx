...
export function TopicDetailPage({ params }: { params: { topicId: string } }) {
  ...
  if (!topic) {
    return (
      <div className="mx-auto max-w-6xl py-20 text-center">
        ...
        <Link to="/student/topics" className="mt-4 inline-block text-sm text-accent hover:underline">
          Back to topics
        </Link>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <nav className="flex items-center gap-2 text-xs text-muted-foreground">
        <Link to="/student/topics" className="hover:text-foreground transition-colors">
          Topics
        </Link>

...
import { stepBatch1 } from "./Year_1_A_Level_Maths/Mixed_Questions/mq2_step_batch1";
import { stepBatch2 } from "./Year_1_A_Level_Maths/Mixed_Questions/mq2_step_batch2";
import { stepBatch3 } from "./Year_1_A_Level_Maths/Mixed_Questions/mq2_step_batch3";
...
export const questions: Question[] = [
  ...
  ...be1,
  ...cg1, ...cg2, ...cg3, ...cg4, ...cg5,
  ...ise1, ...ise2, ...ise3, ...ise4, ...mq1, ...mq2, ...stepBatch1, ...stepBatch2, ...stepBatch3,
  ...t1, ...t2, ...t3, ...t4,

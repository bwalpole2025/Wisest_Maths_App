...
export const undergradManifest: UndergradTopic[] = [
  ...
  { code: "em15", title: "Numerical Methods", prereqs: ["em05", "em08"], visual: false, status: "done" },
  { code: "em16", title: "Probability and Statistics", prereqs: [], visual: false, status: "done" },
];

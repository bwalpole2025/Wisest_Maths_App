...
const components = [
  {
    ...
    title: "Pure Core",
    description:
      "Proof, functions, calculus, parametrics, numerical methods and 3D vectors.",
  ...
  },
  {
    ...
    title: "Statistics",
    description:
      "Probability distributions, hypothesis testing and the normal distribution.",
    category: "Statistics",
    icon: "\u03A3",
    available: false,
  },
  {
    ...
    title: "Mechanics",
    description:
      "Kinematics with calculus, projectile motion and moments — coming soon.",
    category: "Mechanics",
    icon: "F=ma",
    available: false,
  },
...
export default function Year2ComponentsPage() {
